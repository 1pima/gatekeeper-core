...
// HandleAccountVerification - проверка карты/счета для привязки
func (h *Handler) HandleAccountVerification(ctx context.Context, msg *iso8583.Message) *iso8583.Message {
